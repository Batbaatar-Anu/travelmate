...
/// A class that contains all theme configurations for the travel application.
class AppTheme {
  AppTheme._();

  // Travel-specific color palette based on Adaptive Travel Palette
  static const Color primaryLight = Color(0xFF1B365D); // Deep travel blue
  ...
  static const Color backgroundLight = Color(0xFFF9FAFB); // Subtle off-white
  ...
  static const Color onSecondaryLight = Color(0xFF1B365D);
  ...
  static const Color onSecondaryDark = Color(0xFFE2E8F0);
  static const Color onBackgroundDark = Color(0xFFF1F5F9); // Light text
  static const Color onSurfaceDark = Color(0xFFF1F5F9); // Light text
  ...
  static const Color textSecondaryDark = Color(0xFFCBD5E1); // Medium light
  static const Color textDisabledDark = Color(0xFF64748B); // Darker gray

  /// Light theme optimized for travel applications
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      onSecondaryContainer: Color(0xFF8B2500), // Dark orange text
      tertiary: successLight,
      onTertiary: onPrimaryLight,
      tertiaryContainer: Color(0xFFD1FAE5), // Light green container
      onTertiaryContainer: Color(0xFF064E3B), // Dark green text
      error: errorLight,
    ...
    // AppBar theme for travel context
    ...
    // Bottom navigation for travel apps
    ...
    // Floating action button for primary travel actions
  ...
  /// Dark theme optimized for travel applications
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      secondaryContainer: Color(0xFF7C2D12), // Dark orange container
      onSecondaryContainer: Color(0xFFFFE5DB), // Light orange text
      tertiary: successDark,
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF064E3B), // Dark green container
      onTertiaryContainer: Color(0xFFD1FAE5), // Light green text
      error: errorDark,
      onError: onErrorDark,
      surface: surfaceDark,
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for travel destination names
      ...
      // Body styles for travel descriptions
